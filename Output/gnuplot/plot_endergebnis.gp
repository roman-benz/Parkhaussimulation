...
if (system(sprintf('test -f "%s" && echo 1 || echo 0',werte_datei))+0!=1) { print 'Fehler: werte_datei fehlt'; exit }
if (system(sprintf('test -f "%s" && echo 1 || echo 0',auslastung_datei))+0!=1) { print 'Fehler: auslastung_datei fehlt'; exit }
